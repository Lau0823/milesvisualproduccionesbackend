...
export class SeedService {
  ...
  private async seedMediaPosts() {
    ...
    const posts = [
      { title: `Ceremonia editorial`, category: 'BODAS', cloudinaryUrl: `/Bodas/1.jpeg`, cloudinaryPublicId: `Una cobertura pensada para capturar la ceremonia con elegancia, atmósfera y detalle, resaltando la emoción real del momento.`, status: PostStatus.PUBLISHED },
      { title: `Ceremonia editorial`, category: 'BODAS', cloudinaryUrl: `/Bodas/2.jpeg`, cloudinaryPublicId: `Una cobertura pensada para capturar la ceremonia con elegancia, atmósfera y detalle, resaltando la emoción real del momento.`, status: PostStatus.PUBLISHED },
      { title: `Ceremonia editorial`, category: 'BODAS', cloudinaryUrl: `/Bodas/3.jpeg`, cloudinaryPublicId: `Una cobertura pensada para capturar la ceremonia con elegancia, atmósfera y detalle, resaltando la emoción real del momento.`, status: PostStatus.PUBLISHED },
      { title: `Ceremonia editorial`, category: 'BODAS', cloudinaryUrl: `/Bodas/4.jpeg`, cloudinaryPublicId: `Una cobertura pensada para capturar la ceremonia con elegancia, atmósfera y detalle, resaltando la emoción real del momento.`, status: PostStatus.PUBLISHED },
      { title: `Ceremonia editorial`, category: 'BODAS', cloudinaryUrl: `/Bodas/5.jpeg`, cloudinaryPublicId: `Una cobertura pensada para capturar la ceremonia con elegancia, atmósfera y detalle, resaltando la emoción real del momento.`, status: PostStatus.PUBLISHED },
      { title: `Ceremonia editorial`, category: 'BODAS', cloudinaryUrl: `/Bodas/6.jpeg`, cloudinaryPublicId: `Una cobertura pensada para capturar la ceremonia con elegancia, atmósfera y detalle, resaltando la emoción real del momento.`, status: PostStatus.PUBLISHED },
      { title: `Ceremonia editorial`, category: 'BODAS', cloudinaryUrl: `/Bodas/8.jpeg`, cloudinaryPublicId: `Una cobertura pensada para capturar la ceremonia con elegancia, atmósfera y detalle, resaltando la emoción real del momento.`, status: PostStatus.PUBLISHED },
      { title: `Ceremonia editorial`, category: 'BODAS', cloudinaryUrl: `/Bodas/9.jpeg`, cloudinaryPublicId: `Una cobertura pensada para capturar la ceremonia con elegancia, atmósfera y detalle, resaltando la emoción real del momento.`, status: PostStatus.PUBLISHED },
      { title: `Ceremonia editorial`, category: 'BODAS', cloudinaryUrl: `/Bodas/982A2258.jpg.jpeg`, cloudinaryPublicId: `Una cobertura pensada para capturar la ceremonia con elegancia, atmósfera y detalle, resaltando la emoción real del momento.`, status: PostStatus.PUBLISHED },
      ...
      { title: `Editorial clean`, category: 'ESTUDIO', cloudinaryUrl: `/estudio/DSC00984.jpg.jpeg`, cloudinaryPublicId: `Una propuesta visual limpia, con dirección de pose, luz precisa y una atmósfera sofisticada para retratos de alto impacto.`, status: PostStatus.PUBLISHED },
      { title: `Editorial clean`, category: 'ESTUDIO', cloudinaryUrl: `/estudio/DSC09548.jpg (1).jpeg`, cloudinaryPublicId: `Una propuesta visual limpia, con dirección de pose, luz precisa y una atmósfera sofisticada para retratos de alto impacto.`, status: PostStatus.PUBLISHED },
